...
class Encuesta
{
     ...
     * Add resultado
     *
     * @param \HomeBundle\Entity\Resultado $resultado
     *
     * @return Encuesta
     */
    public function addResultado(\HomeBundle\Entity\Resultado $resultado)
    {
     ...
     * @param \HomeBundle\Entity\Resultado $resultado
     */
    public function removeResultado(\HomeBundle\Entity\Resultado $resultado)
    {
